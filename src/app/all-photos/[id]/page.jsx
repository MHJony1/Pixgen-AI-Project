...
import React from 'react';
import { Heart, Download, Share2, Maximize, Calendar, Box, Tag } from 'lucide-react';
...
const PhotoDetailsPage = async ({ params }) => {
    ...
    if (!photo) {
        return <div className="flex justify-center items-center h-screen">Photo not found!</div>;
    }
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-between">
                        <div>
                            ...
                            <div className="bg-zinc-50 dark:bg-zinc-800/50 p-5 rounded-2xl border border-zinc-100 dark:border-zinc-800 mb-8">
                                <p className="text-xs font-bold text-zinc-400 uppercase mb-2 tracking-widest">AI Prompt</p>
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-zinc-400 uppercase font-bold leading-none mb-1">Model</p>
                                        <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">{photo.model}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="p-2 bg-zinc-100 dark:bg-zinc-800 rounded-lg text-zinc-500">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-zinc-400 uppercase font-bold leading-none mb-1">Resolution</p>
                                        <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">{photo.resolution}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {photo.tags.map((tag, index) => (
                                        <span key={index} className="px-3 py-1.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400 rounded-lg text-xs font-medium hover:bg-zinc-200 transition cursor-pointer">
                                            #{tag}
                                        </span>
                                    ))}
                                </div>
